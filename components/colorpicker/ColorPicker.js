...
class ColorPicker extends _react.Component {
  ...
  renderInput() {
    if (!this.props.inline) {
      let inputClassName = (0, _classnames.default)('p-colorpicker-preview p-inputtext', {
  ...
  render() {
    let className = (0, _classnames.default)('p-colorpicker p-component', this.props.className, {
