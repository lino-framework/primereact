...
class Growl extends _react.Component {
  constructor(props) {
    super(props);
    this.state = {
      messages: []
  ...
  render() {
    let className = (0, _classnames.default)('p-growl p-component p-growl-' + this.props.position, this.props.className);
    ...
    }, _react.default.createElement(_reactTransitionGroup.TransitionGroup, null, this.state.messages.map(message => _react.default.createElement(_reactTransitionGroup.CSSTransition, {
      key: message.id,
      classNames: "p-growl",
      timeout: {
        enter: 250,
